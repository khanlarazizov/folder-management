...
{{--    <div class="row mb-2">--}}
{{--        <div class="col-sm-6">--}}
{{--            {{ Breadcrumbs::render('delivery_statement_create',$company, $project, $folder) }}--}}
{{--        </div>--}}
{{--    </div>--}}
{{--@endsection--}}
@section('content')
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-live-search="true" data-placeholder="Müqavilə seç"
                                ...
                                @forelse($contracts as $key )
                                    <option
                                            value="{{$key->id}}"
                                            data-tokens="{{$key->number}}" {{ old('contract_id') == $key->id ? 'selected' : '' }}>{{$key->number}}</option>
                                @empty
                                @endforelse
                            </select>
                            @error('contract_id')
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    value="{{ old('product_service_number_integer') }}">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    value="{{ old('product_service_number_string') }}">
